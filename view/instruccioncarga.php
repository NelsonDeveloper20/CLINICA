...
<p style="    font-size: 30px;text-align: initial;"><span style="font-weight: 600;">
A continuación podrás cargar los documentos faltantes:<br>
<p style="font-size: 23px;
    text-align: initial;">
-	Cargar archivos .pdf, .jpg, .png únicamente.<br>
-	Los documentos deben estar legibles<br>
-	Debe existir un solo documento por cada archivo, no combinados.
</p>
</span> 
</p>
...
<script>
function nextnpage(){ 
    window.location.replace("docPendiente.php");
