...
<div class="card-header border-bottom" style="visibility: hidden;">
...
<p style="    font-size: 64px;"><span style="font-weight: 700;">
¡Muchas Gracias Por Validar Sus Documentos!
</span> 
</p>

<div class="col">
<!-- <button type="button" style="width: 50%;font-size: 14px;" class="btn btn-primary"  onclick="nextnpage();">
<i class="fa fa-chevron-left fa-5"></i><span>  Inicio</span></button> -->
</div>    
    </div>    
<div class="row">
<div class="col-lg-2">                
...
<script>
function nextnpage(){ 
    window.location.replace("docFaltante.php");
}
